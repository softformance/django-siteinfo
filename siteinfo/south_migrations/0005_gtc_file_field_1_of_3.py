...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.gtc_file'
        db.add_column('siteinfo_sitesettings', 'gtc_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.gtc_file'
        db.delete_column('siteinfo_sitesettings', 'gtc_file_id')
    ...
    models = {
        ...
        'siteinfo.sitealiassettings': {
            'Meta': {'object_name': 'SiteAliasSettings'},
        ...
        'siteinfo.sitesettings': {
            ...
            'geoip_redirect': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'gtc': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            'gtc_file': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.File']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
